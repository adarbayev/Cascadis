// Setup script for NAT OIL GROUP organization structure
// This script creates the organization structure for NAT OIL GROUP with
// two legal entities (NAT OIL WEST and NAT OIL EAST) and their sites
